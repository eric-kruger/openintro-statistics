...
\noindent\Large{\textbf{\GSvideohref{youtube-FpvUq8ncI9s?list=PLRevl1PsisXSvGKPygRZa5smjTFfO3SXO} {\color{ForestGreen} Google Sheets: Scatter Plot Review}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-UWDunB_n81E?list=PLRevl1PsisXSvGKPygRZa5smjTFfO3SXO} {\color{ForestGreen} Google Sheets: Correlation}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-PcCGOJxbj8s?list=PLRevl1PsisXSvGKPygRZa5smjTFfO3SXO} {\color{ForestGreen} Google Sheets: Performing Regression in Google Sheets}}}
\normalsize \\

\noindent\Large{\textbf{\GSvideohref{youtube-r-6pOCcGp6E?list=PLRevl1PsisXSvGKPygRZa5smjTFfO3SXO} {\color{ForestGreen} Google Sheets: Predicting scores using the regression formula}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-xukqrcvMPec?list=PLRevl1PsisXSvGKPygRZa5smjTFfO3SXO} {\color{ForestGreen} Google Sheets: Evaluate Regression Models}}}
\normalsize
