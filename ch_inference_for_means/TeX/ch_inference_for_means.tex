...
We'll also learn some new functions in Google sheets & JASP including how to reorganize the data by sorting the data and filtering the data so that we only examine specific variables. Start this chapter by watching this video which covers how to sort and filter the data. \\

\noindent\Large{\textbf{\GSvideohref{youtube-HsR8PNM2Tks&feature=youtu.be&list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Applied Stats Videos: sort and filtering the data}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-32vvXmC4z8s?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Applied Stats Videos: constructing confidence intervals t-distribution}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-qokGnYOihrQ&index=3&list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Applied Stats Videos: hypothesis testing with CI using the t-distribution}}}
\normalsize
...
Two sets of observations are \emph{paired} if each observation in one set has a special correspondence or connection with exactly one observation in the other data set. Paired data are also referred to as analyses of \term{change scores, difference scores or gain scores}. It is easy to confuse all of these terms but the important thing to remember is that they all mean the same thing.}
\end{termBox}
...
\noindent\Large{\textbf{\GSvideohref{youtube-_-aAi_yJWF8&index=4&list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Applied Stats Videos: Paired Samples t-test}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-y4NPttP9V3E&index=5&list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Applied Stats Videos: Two sample t-test}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-SunuDHYVPdM&list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh&index=6} {\color{ForestGreen} Applied Stats Videos: ANOVA and multiple comparisons}}}
\normalsize
