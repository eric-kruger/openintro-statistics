...
We'll also learn some new functions in Google sheets including how to reorganize the data by sorting the data and filtering the data so that we only examine specific variables. Start this chapter by watching this video which covers how to sort and filter the data. \\

\noindent\Large{\textbf{\GSvideohref{youtube-lEQIgEW62IY?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: sort and filtering the data}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-32vvXmC4z8s?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: constructing confidence intervals t-distribution}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-i9ZfkrXv3PQ?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: hypothesis testing with CI using the t-distribution}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-2GhBBItpqe4?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: Paired Samples t-test}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-k00F-5E6a9Q?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: Two sample t-test}}}
\normalsize
...
\noindent\Large{\textbf{\GSvideohref{youtube-XB_8LKwPbcc?list=PLRevl1PsisXT7R0ZVZfUzohYzMENafAVh} {\color{ForestGreen} Google Sheets: ANOVA and multiple comparisons}}}
\normalsize
