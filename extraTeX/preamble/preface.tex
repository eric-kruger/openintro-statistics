...
\textbf{Important there are also videos for that are custom made just for this course. These videos are necessary to watch so that you have the necessary skills to perform statistical analyses in Google Sheets and JASP. Links to these videos will look like the following: } \\

\noindent\Large{\textbf{\GSvideohref{youtube-eVoQ3eIKfK4} {\color{ForestGreen} Click on the green icon to access a section(s) applied videos.}}} 
\normalsize \\

Click on the above Green icon to get an orientation to using stats in applied applications (Google Sheets and JASP). \\
